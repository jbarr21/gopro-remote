...
import com.github.jbarr21.goproremote.common.RxUtils;
...
import com.github.jbarr21.goproremote.util.RxAndroidUtils;
...
import static com.github.jbarr21.goproremote.util.ViewUtils.tintedImage;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void updateCameraCurrentState() {
        GoProUtils.fetchCameraState(goProApi)
                ...
                .subscribe(response -> {
                    try {
                        GoProState state = GoProState.from(response);
    ...
    public void onModeSelected() {
        ...
        updateFabIcon();
        Observable<Object> actionObservable = null;
        switch (mode) {
